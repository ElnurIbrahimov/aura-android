...
type InboundMessage = ExtractPageMsg | GetDomMsg | ExecActionMsg | ShowOcrOverlayMsg | PageTranslateMsg | TranslateToggleModeMsg | TranslateRemoveMsg | TranslateChangeLangMsg | ScrollToHighlightMsg | ShowDockMsg;
