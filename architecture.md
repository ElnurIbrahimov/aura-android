...
### Room Databases (11)
- MemoryDB v19, ConversationDB v6, ProactiveEventDB v6, TaskDB v6, EvolutionDB v4
...
- 2,830 unit tests, 0 failures (gated by `scripts/check-test-count.sh`)
...
- **Candidates** come from `memories_fts` (FTS4, MemoryDatabase v19), kept current by SQL
