...
MODELS: dict[str, ModelProfile] = {
    ...
    # ── Crof (nahcrof) — OpenAI-compatible third-party gateway ──────────
    # Cheaper than Ollama Cloud for same flagship models; no concurrency cap.
    "crof:deepseek-v4-pro": ModelProfile(
        name="crof:deepseek-v4-pro",
        provider="crof",
        cost_in_per_1k=0.00115, cost_out_per_1k=0.003,
        context_length=1_000_000,
        specialties=(SPECIALTY_REASONING, SPECIALTY_LONGCTX, SPECIALTY_CODE),
        latency_tier=LATENCY_SLOW,
        notes="DeepSeek V4 Pro via crof.ai (Q4_0). 1M ctx flagship.",
    ),
    "crof:qwen3.6-27b": ModelProfile(
        name="crof:qwen3.6-27b",
        provider="crof",
        cost_in_per_1k=0.0002, cost_out_per_1k=0.0015,
        context_length=262_144,
        specialties=(SPECIALTY_REASONING, SPECIALTY_FAST, SPECIALTY_CHEAP),
        latency_tier=LATENCY_MEDIUM,
        active_params_b=27,
        notes="Qwen3.6 27B dense via crof.ai (Q4_0). reasoning_effort enabled, cheap reasoning.",
    ),
    "crof:kimi-k2.6": ModelProfile(
        name="crof:kimi-k2.6",
        provider="crof",
        cost_in_per_1k=0.0005, cost_out_per_1k=0.00199,
        context_length=262_144,
        specialties=(SPECIALTY_REASONING, SPECIALTY_LONGCTX),
        latency_tier=LATENCY_SLOW,
        mmlu_pro=86.4, swe_bench=76.8, aime=96.1,
        active_params_b=32, total_params_b=1000,
        notes="Kimi K2.6 via crof.ai (Q3_K_L). Cheapest route to K2.6.",
    ),
    "crof:kimi-k2.6-precision": ModelProfile(
        name="crof:kimi-k2.6-precision",
        provider="crof",
        cost_in_per_1k=0.00055, cost_out_per_1k=0.0027,
        context_length=262_144,
        specialties=(SPECIALTY_REASONING, SPECIALTY_LONGCTX),
        latency_tier=LATENCY_SLOW,
        mmlu_pro=86.4, swe_bench=76.8, aime=96.1,
        active_params_b=32, total_params_b=1000,
        notes="Kimi K2.6 int4 via crof.ai. Higher-quality quant.",
    ),
    "crof:glm-5.1": ModelProfile(
        name="crof:glm-5.1",
        provider="crof",
        cost_in_per_1k=0.00045, cost_out_per_1k=0.0021,
        context_length=202_752,
        specialties=(SPECIALTY_CODE, SPECIALTY_REASONING),
        latency_tier=LATENCY_MEDIUM,
        swe_bench=77.8,
        active_params_b=40, total_params_b=744,
        notes="GLM-5.1 via crof.ai (Q6_K). Cheaper than ollama_cloud glm-5.1.",
    ),
    "crof:glm-5.1-precision": ModelProfile(
        name="crof:glm-5.1-precision",
        provider="crof",
        cost_in_per_1k=0.00080, cost_out_per_1k=0.0029,
        context_length=202_752,
        specialties=(SPECIALTY_CODE, SPECIALTY_REASONING),
        latency_tier=LATENCY_MEDIUM,
        swe_bench=77.8,
        active_params_b=40, total_params_b=744,
        notes="GLM-5.1 Q8_0 via crof.ai. Higher-precision variant.",
    ),
}
