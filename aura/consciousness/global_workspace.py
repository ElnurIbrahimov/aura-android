...
class GlobalWorkspaceEngine:
    ...
    def _gather_strategy_bandit(self) -> Optional[WorkspaceContent]:
        ...
        from aura.consciousness.strategy_bandit import get_strategy_bandit, ProblemCategory
    ...
    def _emit_broadcast(self, broadcast: BroadcastEvent):
        ...
        try:
            ...
            if hasattr(daemon, "event_bus") and daemon.event_bus is not None:
                ...
                # event_bus.publish() is async — schedule it thread-safely
                try:
                ...
                if loop is not None:
                    asyncio.run_coroutine_threadsafe(
                        daemon.event_bus.publish("workspace", payload), loop
                    )
        except Exception as e:
