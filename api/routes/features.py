...
from api.utils import get_agent, safe_error_detail
...
# ============================================================================
# A-MEM and Hybrid Memory — REMOVED (2026-04-09 R6)
# A-MEM was replaced by UnifiedMemory. The tools 'amem' and 'hybrid_amem'
# are no longer registered, so all endpoints below returned empty/error.
# Endpoints: /amem/stats, /amem/notes, /amem/note/{id}, /amem/search,
#            /amem/remember, /amem/consolidate, /amem/boxes,
#            /hybrid-memory/stats, /hybrid-memory/search, /hybrid-memory/context
# Use /api/memory/* instead (backed by UnifiedMemory).
# ============================================================================
